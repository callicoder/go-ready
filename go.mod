module github.com/callicoder/go-ready

require (
	github.com/avct/uasurfer v0.0.0-20180927160713-2ce2c8fcd544 // indirect
	...
	github.com/mattermost/mattermost-server v5.6.1+incompatible // indirect
	github.com/mattermost/viper v1.0.2 // indirect
